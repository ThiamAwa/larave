                ...
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="index.html">
                        ...
                        <b class="logo-icon p-l-10">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="assets/images/O.jpg" alt="homepage" class="light-logo"  width="200" height="90" />
                        ...
                        <li class="nav-item dropdown">
                                        ...
                                        <div class="">
                                            ...
                                            <a href="javascript:void(0)" class="link border-top">
                                                <div class="d-flex no-block align-items-center p-10">
                                                    ...
                                                    <div class="m-l-10">
                                                        <a class="dropdown-item" href="javascript:void(0)"><i class="ti-user m-r-5 m-l-5"></i> Login</a>
                                                    </div>
                                                </div>
                                            </a>
                                            <!-- Message -->
                                            <a href="javascript:void(0)" class="link border-top">
                                                <div class="d-flex no-block align-items-center p-10">
                                                    ...
                                                    <div class="m-l-10">
                                                        <a class="dropdown-item" href="#"><i class="fa fa-power-off m-r-5 m-l-5"></i> Register</a>
                                                    </div>
                                                </div>
                                            </a>
                            ...
                            @auth
                               {{-- <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="assets/images/users/{{ Auth::user()->name }}" alt="user" class="rounded-circle" width="31"></a> --}}
                                <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic fw-bold" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> @if(Auth::check() && Auth::user()->photo)
